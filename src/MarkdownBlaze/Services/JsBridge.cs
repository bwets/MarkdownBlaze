...
public static class JsBridge
{
    ...
    public static event Action<double>? DocumentZoomed;       // new document zoom, 1 = natural size
    ...
    [JSInvokable] public static void OnDocumentZoomed(double zoom) => DocumentZoomed?.Invoke(zoom);
